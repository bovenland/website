<template>
  <div class="page home-page">
    <div class="intro">
      Een visuele en cartografische ontdekkingsreis waarin we onderzoeken wat
    ...
    <div class="container column">
      ...
      <!-- Hoofdstukken -->
      <FoldDownMenu :children="chapters" collapsible="false">
