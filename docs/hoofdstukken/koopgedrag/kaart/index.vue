...
export default {
  ...
  mounted: function () {
    ...
    const domain = [0, 174]
    const colorFrom = '#4861ED'
    const colorTo = '#F0F462'
    ...
    map.on('load', () => {
      map.addSource('bovenland', {
        ...
        tiles: ['https://s3.eu-central-1.amazonaws.com/files.boven.land/topology-of-commerce/tiles/packed/{z}/{x}/{y}.pbf'],
        // tiles: ['https://files.boven.land/topology-of-commerce/tiles/packed/{z}/{x}/{y}.pbf'],
        maxzoom: 16
      })
